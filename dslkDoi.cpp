    ...
    if (Q.Head ==NULL || vt ==1){
        ...
        for (NodeHD *k = Q.Head;k!=NULL;k=k->next){
            ...
            if (dem == vt){
                ...
                chen->next=k; k->previous = chen;
                truoc->next=chen; chen->previous = truoc;
                break;
            }
            truoc=k;
        }
...
void dichVuDuocSDNN(listHD Q){
  ...
  cout <<"\nDich vu duoc su dung nhieu nhat voi tong "<<maximum<<" lan su dung la: ";
